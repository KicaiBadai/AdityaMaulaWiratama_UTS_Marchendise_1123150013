    ...
    return Scaffold(
      ...
      body: Consumer<OrderProvider>(
        builder: (context, orderProv, _) {
          // Gunakan status khusus untuk daftar pesanan (bukan checkoutStatus)
          if (orderProv.ordersStatus == OrderStatus.loading) {
            return const Center(child: CircularProgressIndicator());
          }

          if (orderProv.ordersStatus == OrderStatus.error) {
            return Center(
              child: Column(
                ...
                children: [
                  ...
                  Text(orderProv.ordersError ?? 'Terjadi kesalahan'),
